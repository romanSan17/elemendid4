...
namespace Elemendid_vormis_TARpv23
{
    public partial class math_quiz : Form
    {
        ...
        public math_quiz(int width, int height)
        {
            InitializeComponent();
            this.Width = width;
            this.Height = height;
        ...
        public void StartTheQuiz()
        {
            ...
            baseNumber = randomizer.Next(2, 11);
            exponent = randomizer.Next(1, 4);
            degreeLeftLabel.Text = baseNumber.ToString();
            degreeRightLabel.Text = exponent.ToString();
            summa.Value = 0;
        ...
        private bool CheckTheAnswer()
        {
            return ((addend1 + addend2 == sum.Value)
                ...
                && (Math.Pow(baseNumber, exponent) == (double)summa.Value);
        }
        ...
        private void GenerateExponentiationProblem()
        {
            baseNumber = randomizer.Next(2, 11);
            exponent = randomizer.Next(1, 4);
            degreeLeftLabel.Text = baseNumber.ToString();
        ...
        private void ShowCorrectAnswers()
        {
            ...
            product.Value = multiplicand * multiplier;
            quotient.Value = dividend / divisor;
            summa.Value = (decimal)Math.Pow(baseNumber, exponent);
        }
